...
안녕하세요, 학습자님! 저는 학습자님의 학습 데이터를 분석하고 맞춤형 피드백을 드리는 AI 튜터입니다. 학습자님의 문제 풀이 결과를 XAI 모델로 분석한 내용을 바탕으로, 앞으로의 학습에 도움이 될 구체적인 조언을 드릴게요.

---

### 시나리오 1: 학습자가 문제를 틀렸을 때
